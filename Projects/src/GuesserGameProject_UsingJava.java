...
class Player1{
	...
	public int player1_num() {
		...
		while(player1_num>10) {
			System.out.println("The number is Greater than 10, You will be out of the game - please Enter the number between 0 to 10 ");
			player1_num = scan.nextInt();
		}
		return player1_num;
	}	
...
class Umpire{
	public void game(){
		...
		//All player guesses the right answer, but they can play again because there can be only one winner
		if((guess.guesser_num == p1.player1_num) && (guess.guesser_num == p2.player2_num) && (guess.guesser_num == p3.player3_num))  {
...
//main method
public class GuesserGameProject_UsingJava {
